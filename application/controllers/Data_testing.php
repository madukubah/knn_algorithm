...
class Data_testing extends Admin_Controller {
  ...
  public function index() 
  {
    ...
    //   $data['files'] = $data;
      ...
      $this->load->view("_template/sidebar_menu");
          $this->load->view("data_testing/View_list",$data);
  ...
  {     
        ...
        if ($this->form_validation->run() == true) 
        {
            ...
            $this->load->view("_template/header");
            $this->load->view("_template/sidebar_menu");
                $this->load->view("data_testing/View_create",$data);
            $this->load->view("_template/footer");  
        }
  }
  ...
  public function normalize(  )
  {
        ...
        for( $i=0; $i< count( $files ); $i++ )
        {
            ...
            $files[ $i ]->data_tanggungan = round( $files[ $i ]->data_tanggungan,3);
        }
        $this->m_data_testing_normalized->clear( );
